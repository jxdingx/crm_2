...
<script type="text/javascript">
	...
	function FormSubmit() {
		$('#Form').form({
			url : "cusService_updatefeedback.action",
			onSubmit : function() {
...
<body style="margin: 1px;">
	...
	<div id="tb">
		<div>
			<a href="javascript:proceService()" class="easyui-linkbutton" data-options="iconCls:'icon-fwfk', plain:'true'">客户服务反馈</a>
		</div>
	</div>
	<div id="win">
		<form method="post" id="Form" enctype="multipart/form-data">
			...
			<table style="margin: 0px 0px 0px 20px; border-collapse: separate; border-spacing: 5px;" cellpadding="5">
				...
				<tr>
					...
					<td>
						<input name="serviceProceResult" class="easyui-textbox" data-options="required:true,panelHeight:'auto'" style="width: 130px; height: 30px;">
					</td>
					<td>
						<label>客户满意度:</label>
					</td>
					<td>
						<select name="myd" class="easyui-combobox" data-options="required:true,editable:false" style="width: 130px; height: 30px;">
							<option value="☆">☆</option>
							<option value="☆☆">☆☆</option>
							<option value="☆☆☆">☆☆☆</option>
							<option value="☆☆☆☆">☆☆☆☆</option>
