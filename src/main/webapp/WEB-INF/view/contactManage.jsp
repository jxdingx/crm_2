...
<%out.print(request.getParameter("id"));%>
	...
	function addcusContact() {
		$('#Form').form("clear");
		$('#win').window("open");
	}

	function updatecusContact() {
		if (!selectrow) {
		...
		<table id="dg" style="width: 100%; height: 600px;">
			<thead>
				<tr>
					...
					<th data-options="field:'contactTime',align:'center',width:'100'">交往时间</th>
					<th data-options="field:'address',align:'center',width:'100'">交往地点</th>
					<th data-options="field:'overView',align:'center',width:'100'">概要</th>
				</tr>
			</thead>
		</table>
		<div id="tb">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="addcusContact()">添加</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="updatecusContact()">修改</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="deletecusContact()">删除</a>
		</div>
	</div>
	<div id="win">
		<form method="post" id="Form" enctype="multipart/form-data">
			...
			<table style="margin: 0px 0px 0px 40px; border-collapse: separate; border-spacing: 7px;" cellpadding="7">
				<tr>
					...
					<td>
						<input name="contactTime" class="easyui-datebox" data-options="editable:false,required:true" style="width: 130px; height: 30px;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input name="address" class="easyui-textbox" data-options="required:true" style="width: 130px; height: 30px;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input name="overView" class="easyui-textbox" data-options="required:true" style="width: 130px; height: 30px;">
					</td>
				</tr>
			</table>
			<br>
