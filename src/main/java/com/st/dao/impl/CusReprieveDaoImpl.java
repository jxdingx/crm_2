...
@Repository
public class CusReprieveDaoImpl extends BaseDaoImpl implements CusReprieveDao {
	...
	public List<CusReprieveEntity> findAll(String hql) {
		// TODO Auto-generated method stub
		return (List<CusReprieveEntity>) getHibernateTemplate().find(hql);
	}
	...
	public List<CusReprieveEntity> findAllPage(String hql, Integer first, Integer max) {
		...
		return (List<CusReprieveEntity>) getHibernateTemplate().execute(new HibernateCallback<Object>() {
			@Override
	...
	public CusReprieveEntity get(Integer id) {
		// TODO Auto-generated method stub
		return getHibernateTemplate().get(CusReprieveEntity.class, id);
	}
